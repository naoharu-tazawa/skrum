...
export default class ChartHighlightOverlay extends AbstractSeries {
  ...
  onParentMouseDown(e) {
    ...
    // TODO: Eventually support drawing as a full rectangle, if desired.
    // Currently the code supports 'x' only
    this.setState({
      drawing: true,
      drawArea: {
        top: 0,
