...
CREATE TABLE IF NOT EXISTS `skm`.`t_email_settings` (
  ...
  `okr_timeline` CHAR(2) NOT NULL DEFAULT '1' COMMENT 'タイムライン投稿通知メール設定',
  `one_on_one` CHAR(2) NOT NULL DEFAULT '1' COMMENT '1on1投稿通知メール設定',
...
-- -----------------------------------------------------
-- Table `skm`.`t_upload_control`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skm`.`t_upload_control` (
  ...
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  PRIMARY KEY (`id`),
  INDEX `idx_upload_control_01` (`company_id` ASC))
ENGINE = InnoDB
COMMENT = 'アップロード管理';
...
-- Table `skm`.`t_upload`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skm`.`t_upload` (
  ...
  `line_data` VARCHAR(255) NULL COMMENT '行データ',
  `batch_execution_status` CHAR(2) NULL COMMENT 'アップロード後バッチ実行ステータス',
  `result` TINYINT(1) NULL COMMENT '実行結果',
  `message` VARCHAR(255) NULL COMMENT 'メッセージ',
  `temporary_password` VARCHAR(255) NULL COMMENT '仮パスワード',
  `created_at` DATETIME NULL DEFAULT NULL COMMENT '登録日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT '更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  PRIMARY KEY (`id`),
  INDEX `idx_upload_01` (`upload_control_id` ASC),
  CONSTRAINT `fk_upload_id`
    FOREIGN KEY (`upload_control_id`)
    REFERENCES `skm`.`t_upload_control` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'アップロード';
...
-- Table `skm`.`t_post_to`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skm`.`t_post_to` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `post_id` BIGINT(20) UNSIGNED NOT NULL COMMENT '投稿ID',
  ...
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  PRIMARY KEY (`id`),
  INDEX `fk_post_to_post_id_idx` (`post_id` ASC),
  CONSTRAINT `fk_post_to_post_id`
    FOREIGN KEY (`post_id`)
    REFERENCES `skm`.`t_post` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `skm`.`t_one_on_one`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skm`.`t_one_on_one` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `one_on_one_type` CHAR(2) NOT NULL COMMENT '1on1種別',
  `sender_user_id` INT(11) UNSIGNED NOT NULL COMMENT '送信者ユーザID',
  `target_date` DATE NULL COMMENT '対象日',
  `due_date` DATE NULL COMMENT '期限日',
  `feedback_type` CHAR(2) NULL COMMENT 'フィードバック種別',
  `interviewee_user_id` INT(11) UNSIGNED NULL COMMENT '面談相手ユーザID',
  `okr_id` INT(11) UNSIGNED NULL COMMENT 'OKRID',
  `okr_activity_id` BIGINT(20) UNSIGNED NULL COMMENT 'OKRアクティビティID',
  `body` TEXT NOT NULL COMMENT '本文',
  `new_arrival_datetime` DATETIME NULL COMMENT '新着日時',
  `parent_id` BIGINT(20) UNSIGNED NULL COMMENT '親1on1ID',
  `created_at` DATETIME NULL DEFAULT NULL COMMENT '登録日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT '更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  PRIMARY KEY (`id`),
  INDEX `idx_one_on_one_01` (`parent_id` ASC),
  INDEX `idx_one_on_one_02` (`sender_user_id` ASC),
  INDEX `idx_one_on_one_03` (`new_arrival_datetime` ASC),
  CONSTRAINT `fk_one_on_one_parent_id`
    FOREIGN KEY (`parent_id`)
    REFERENCES `skm`.`t_one_on_one` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '1on1';
...
-- -----------------------------------------------------
-- Table `skm`.`t_one_on_one_to`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skm`.`t_one_on_one_to` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `one_on_one_id` BIGINT(20) UNSIGNED NOT NULL COMMENT '1on1ID',
  `user_id` INT(11) UNSIGNED NOT NULL COMMENT 'ユーザID',
  `read_flg` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '既読フラグ',
  `created_at` DATETIME NULL DEFAULT NULL COMMENT '登録日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT '更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  PRIMARY KEY (`id`),
  INDEX `idx_one_on_one_to_01` (`one_on_one_id` ASC),
  CONSTRAINT `fk_one_on_one_to_one_on_one_id`
