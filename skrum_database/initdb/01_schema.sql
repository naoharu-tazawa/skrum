...
CREATE TABLE IF NOT EXISTS `skm`.`m_role_assignment` (
  ...
  `role_level` VARCHAR(45) NOT NULL COMMENT 'ロールレベル',
...
CREATE TABLE IF NOT EXISTS `skm`.`m_user` (
  ...
  `last_access_datetime` DATETIME NULL COMMENT '最終アクセス日時',
  ...
  INDEX `fk_user_role_assignment_id_idx` (`role_assignment_id` ASC),
...
CREATE TABLE IF NOT EXISTS `skm`.`m_group` (
  ...
  `mission` VARCHAR(255) NULL COMMENT 'ミッション',
  `company_flg` TINYINT(1) NULL DEFAULT 0 COMMENT '会社フラグ',
  `image_path` VARCHAR(45) NULL,
  `created_at` DATETIME NULL DEFAULT NULL COMMENT '登録日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT '更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  ...
  INDEX `idx_group_02` (`leader_user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `skm`.`m_role` (
  ...
  `level` SMALLINT(2) NOT NULL COMMENT 'ロールレベル',
...
CREATE TABLE IF NOT EXISTS `skm`.`t_okr` (
  ...
  `ratio_locked_flg` TINYINT(1) NULL DEFAULT NULL COMMENT '持分比率ロックフラグ',
  `created_at` DATETIME NULL DEFAULT NULL COMMENT '登録日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT '更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  PRIMARY KEY (`okr_id`),
...
CREATE TABLE IF NOT EXISTS `skm`.`t_payment` (
  ...
  `bank_code` CHAR(8) NULL COMMENT '銀行コード',
  `branch_code` CHAR(4) NULL COMMENT '支店コード',
  `account_type` CHAR(2) NULL COMMENT '口座種別',
  `account_number` CHAR(8) NULL COMMENT '口座番号',
  `account_holder` VARCHAR(255) NULL COMMENT '口座名義人',
  `created_at` DATETIME NULL DEFAULT NULL COMMENT '登録日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT '更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `skm`.`m_normal_timeframe_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skm`.`m_normal_timeframe_detail` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `normal_timeframe_id` INT(11) UNSIGNED NOT NULL COMMENT '規定タイムフレームID',
  `timeframe_name` VARCHAR(45) NOT NULL COMMENT '規定タイムフレーム名',
  `start_date` CHAR(5) NOT NULL COMMENT '開始日',
  `end_date` CHAR(5) NOT NULL COMMENT '終了日',
  `display_order` VARCHAR(45) NOT NULL COMMENT '表示順',
  `created_at` DATETIME NULL DEFAULT NULL COMMENT '登録日時',
  `updated_at` DATETIME NULL DEFAULT NULL COMMENT '更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT '削除日時',
  PRIMARY KEY (`id`),
  INDEX `idx_normal_timeframe_detail_02` (`start_date` ASC),
  INDEX `idx_normal_timeframe_detail_03` (`end_date` ASC))
ENGINE = InnoDB
COMMENT = '規定タイムフレーム詳細';
...
CREATE TABLE IF NOT EXISTS `skm`.`t_okr_activity` (
  ...
  `achievement_rate` DECIMAL(4,1) UNSIGNED NULL COMMENT '達成率',
  `changed_percentage` DECIMAL(4,1) NULL COMMENT '増加パーセンテージ',
  ...
  INDEX `idx_okr_activity_02` (`activity_datetime` ASC),
...
CREATE TABLE IF NOT EXISTS `skm`.`t_post` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `timeline_owner_group_id` INT(11) UNSIGNED NULL COMMENT 'タイムラインオーナーグループID',
  `poster_id` INT(11) UNSIGNED NULL COMMENT '投稿ユーザID',
